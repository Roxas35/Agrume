CREATE USER agrume PASSWORD 'agrume';

CREATE DATABASE agrume;

CREATE TYPE Familly AS ENUM ('orange', 'pamplemousse','citron','clémentine','mandarine', 'kumquat');

CREATE TABLE species(
	id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	scientific_name text UNIQUE NOT NULL,
	vernacular_name text UNIQUE NOT NULL,
	family_id familly NOT NULL
);
...
ALTER DATABASE "agrume" OWNER TO agrume;
ALTER TABLE species OWNER TO agrume;
ALTER TABLE variety OWNER TO agrume;
ALTER TYPE familly OWNER TO agrume;

SELECT * FROM species;

SELECT * FROM variety;

UPDATE variety SET bitterness = 5 - bitterness;

INSERT INTO species (scientific, vernacular,family_id) VALUES
...
INSERT INTO variety (cultivar, juiciness, bitterness, species_id) VALUES
('Osbeck', 4, 5, 1),
('Moro', 5, 5, 1),
('Sanguinello', 2, 5, 1),
('Hook', 3, 0, 2),
